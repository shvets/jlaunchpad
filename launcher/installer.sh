...
JLAUNCHPAD_COMMON_PROJECT=$JLAUNCHPAD_PROJECT/projects/universal-launcher-common
POM_READER_PROJECT=$JLAUNCHPAD_PROJECT/projects/pom-reader
JLAUNCHPAD_PROJECT=$JLAUNCHPAD_PROJECT/projects/universal-launcher

CLASSPATH=$BOOTSTRAP_MINI_PROJECT/target/bootstrap-mini.jar
CLASSPATH=$CLASSPATH:$JLAUNCHPAD_COMMON_PROJECT/target/universal-launcher-common.jar
CLASSPATH=$CLASSPATH:$POM_READER_PROJECT/target/pom-reader.jar
CLASSPATH=$CLASSPATH:$JLAUNCHPAD_PROJECT/target/universal-launcher.jar
